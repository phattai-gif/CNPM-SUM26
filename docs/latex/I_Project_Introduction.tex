...
\addcontentsline{toc}{section}{I. Project Introduction}
\setcounter{section}{1}
% Number subsections in this chapter as 1, 2, ... (not 1.1)
\renewcommand{\thesubsection}{\arabic{subsection}}
\setcounter{subsection}{0}
\subsection{Project Information}
\label{subsec:project_information}
...
\end{itemize}
% Restore subsection numbering format to default (section.subsection)
