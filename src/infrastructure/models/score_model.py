from sqlalchemy import Column, BigInteger, Text, Numeric, DateTime, ForeignKey, UniqueConstraint
...
class ScoreModel(Base):
    ...
    __table_args__ = (
        UniqueConstraint('submission_id', 'judge_id', 'criteria_id', name='unique_judge_submission_criteria'),
