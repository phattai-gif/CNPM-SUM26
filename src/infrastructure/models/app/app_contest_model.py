...
class ContestModel(Base):
    ...
    categories_json = Column(JSON, nullable=False, default=list, server_default=sa_text("'[]'"))
    awards_json = Column(JSON, nullable=False, default=list, server_default=sa_text("'[]'"))
