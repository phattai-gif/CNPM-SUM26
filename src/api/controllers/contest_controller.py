...
@public_bp.route('/submission_review/<int:submission_id>', methods=['GET'])
def submission_review(submission_id):
    """
    Public submission review page showing submission and AI warnings (mock data).
    """
    submission = {
        'id': submission_id,
        ...
        'flagged': True,
        'content': 'Mô tả tác phẩm: khung cảnh bình minh...'
    }
    ...
    ai_warnings = [
        {
            ...
            'details': {'summary': 'Phát hiện hạt phim giả và đường nét bất thường.'}
        }
    ]
...
@public_bp.route('/judge_grading/<int:submission_id>', methods=['GET', 'POST'])
def public_judge_grading(submission_id):
    """
    Public judge grading page (mock). Accepts POST to mock-save scores via flash.
    """
